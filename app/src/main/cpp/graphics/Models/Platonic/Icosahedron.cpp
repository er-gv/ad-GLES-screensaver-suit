...
void Polyhedrons::Icosahedron::render(glm::mat4& viewMat, glm::mat4& projectionMat, const glm::vec3& lightPos) {
    ...
    glUniform3f(paintColorHandler, 0.6, 0.2, 0.2);
    glUniform3f(materialColorHandler, 0.941176f, 0.9019607f, 0.549019f);
...
bool Polyhedrons::Icosahedron::addMaterials(){
    const char vertex_shader[] = "shaders/turbulence/vertex_texture_3D.glsl";
    const char fragment_shader[] = "shaders/paint_spatter/fragment.glsl"; //paint_spatter
