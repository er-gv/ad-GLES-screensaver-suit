...
namespace Polyhedrons {
    ...
    Polyhedron::Polyhedron() : HardCodedModel() {
    ...
    Polyhedron::Polyhedron(const glm::mat4& transform) : HardCodedModel(transform) {
        vertexDataBuffer = nullptr;
        vertices = nullptr;
        faces = nullptr;
        ibo = vbo = nullptr;
    ...
    Polyhedron::Polyhedron(const Polyhedron& p) : HardCodedModel(p){
        *this = p;
    };
