package com.learnopengles.android.quantizedColor;
...
public class QuantizedColorNativeRenderer implements GLSurfaceView.Renderer {
    ...
    public QuantizedColorNativeRenderer(Activity activity) {
        mActivity = activity;
    }
